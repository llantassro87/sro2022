...
<head>
    ...
    <link href="assets/css/custom_pdf.css" rel="stylesheet" type="text/css">  
    <link href="assets/css/custom_page.css" rel="stylesheet" type="text/css">  
</head>
<body>
        ...
        <table cellpadding="0" cellspacing="0" width="100%">
            <tr>
                <td colspan="2" class="text-center">
                    <span style="font-size: 25px; font-weight: bold;">Sistema SRO</span>
                </td>
            </tr>
            <tr>
                <td width="30%" style="vertical-align: top; padding-top: 10px; position: relative;">
                    <img src="assets/img/logo_sro.jpeg" class="invoice-logo">
                </td>
                <td width="70%" class="text-left text-company" style="vertical-align: top; padding-top: 10px;">
                    ...
                    <br>
                    @if ($reportType != 0)
                        <span style="font-size: 16px;"><strong>Fecha del reporte: {{ $fromDate }} al {{ $toDate }}</strong></span>
                    @else
