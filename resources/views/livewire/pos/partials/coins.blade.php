                    ...
                    <div class="card-body">
                        <div class="input-group input-group-md mb-3">
                            <div class="input-group-prepend">
                                <span class="input-group-text input-gp hideonsm" style="background-color: #3b3f5c; color: white;">
                                    Efectivo (F8)
                                </span>
                            </div>
                            <input type="number" 
                            wire:model="efectivo" 
                            id="cash"
                            wire:change="updateCash($('#cash').val())"
                            wire:keydown.enter="saveSale"
                            class="form-control text-center" 
                            value="{{ $efectivo }}"
                            step=".01"
                            >
                            <div class="input-group-prepend" wire:click="$set('change', 0)">
