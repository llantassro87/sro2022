    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-sm-12">
                        <label style="color: #3b3f5c;">Nombre del permiso:</label>
                        <div class="input-group mb-3">
                            ...
                            <input type="text" wire:model.lazy="permissionName" class="form-control" placeholder="Escribir el nombre del permiso: product_index">
                        </div>
                        <div>
